<template>
  <div
    class="w-[90%] min-auto mx-auto bg-gray-300 shadow-lg py-10 px-3 lg:px-28 rounded-xl"
  >
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="flex items-center mt-5 gap-3 flex-wrap justify-center">
          <div
            ...
            class="mt-10"
          >
            <router-link to="/expertPage/DetailsFilesExpert">
              <div
